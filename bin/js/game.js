...
var RunningState = (function (_super) {
    ...
    RunningState.prototype.create = function () {
        ...
        this.button4 = new ButtonObject(this.game, this.game.width - 30, this.game.height + 200, "shopButton", this.shopButtonCliced);
        this.button4.setSizes(50, 50);
...
var Tree = (function (_super) {
    ...
    function Tree(game, x, y, currentLevel, keys, maxLevel, startSun, startWater, startEarth) {
    ...
    Tree.prototype.upgrade = function (sun, water, earth) {
...
var AppleTree = (function (_super) {
    ...
    function AppleTree(game, x, y, level) {
        ...
        var water = 20;
        var earth = 20;
        _super.call(this, game, x, y, level, keys, maxLevel, sun, water, earth);
    }
    return AppleTree;
}(Tree));
